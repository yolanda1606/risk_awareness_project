...
def generate_launch_description():
    ...
    # Resources for Gazebo to find meshes
    ...
    # 3. XACRO COMMANDS
    # We pass 'arm_id' so the macro generates links named r1_link0, r2_link0 etc.
    ...
    # Ensure your SDF world name is <world name="semantic_world">
    ...
    # D. Bridge
    # CRITICAL: These paths assume your SDF file has <world name="semantic_world">
    # If your world is named "default", change "semantic_world" to "default" below.
    bridge = Node(
        ...
        arguments=[
            ...
            # Joint States
            # The Xacro below adds a plugin that publishes to /model/{name}/joint_state
